...
describe('Matrix2D operations', () => {
  test('create default Matrix2D', () => {
    expect(matrix2D()).toEqual(new Float32Array([1, 0, 0, 1, 0, 0]))
  })

  test('clone a Matrix2D', () => {
    const m = matrix2D([2, 3, 4, 5, 6, 7])
    const cloned = clone(m)
    expect(cloned).toEqual(new Float32Array([2, 3, 4, 5, 6, 7]))
  ...
  test('identity matrix', () => {
    const m = matrix2D()
    identity(m)
    expect(m).toEqual(new Float32Array([1, 0, 0, 1, 0, 0]))
  })
  ...
  test('copy matrix', () => {
    ...
    const m2 = matrix2D()
    copy(m2, m1)
    expect(m2).toEqual(new Float32Array([2, 3, 4, 5, 6, 7]))
  })
  ...
  test('invert matrix', () => {
    ...
    expect(inverted).toEqual(new Float32Array([-2, 1, 1.5, -0.5, 1, -2]))
  })
  ...
  test('multiply two matrices', () => {
    ...
    expect(result).toEqual(new Float32Array([31, 46, 39, 58, 52, 76]))
  })
  ...
  test('scale matrix', () => {
    ...
    expect(scaled).toEqual(new Float32Array([2, 0, 0, 3, 0, 0]))
  })

  test('translate matrix', () => {
    const m = matrix2D()
    const translated = translate(matrix2D(), m, [1, 2])
    expect(translated).toEqual(new Float32Array([1, 0, 0, 1, 1, 2]))
  })
  ...
  test('from scaling matrix', () => {
    ...
    expect(m).toEqual(new Float32Array([2, 0, 0, 3, 0, 0]))
  })

  test('from translation matrix', () => {
    const m = fromTranslation(matrix2D(), [1, 2])
    expect(m).toEqual(new Float32Array([1, 0, 0, 1, 1, 2]))
  })
  ...
  test('add two matrices', () => {
    ...
    expect(result).toEqual(new Float32Array([8, 10, 12, 14, 16, 18]))
  })
  ...
  test('subtract two matrices', () => {
    ...
    expect(result).toEqual(new Float32Array([6, 6, 6, 6, 6, 6]))
  })
  ...
  test('equality check with epsilon for matrices', () => {
    ...
    const m2 = matrix2D([1.000002, 1.000003, 1.000004, 1.000005, 1.000006, 1.000007])
