...
export const copy = (v: Vector2, a: Vector2) => set(v, a.x, a.y)

export const reset = (v: Vector2) => set(v, 0, 0)

export const add = (v: Vector2, a: Vector2, b: Vector2) => set(v, a.x + b.x, a.y + b.y)

export const subtract = (v: Vector2, a: Vector2, b: Vector2) => set(v, a.x - b.x, a.y - b.y)

export const multiply = (v: Vector2, a: Vector2, b: Vector2) => set(v, a.x * b.x, a.y * b.y)

export const divide = (v: Vector2, a: Vector2, b: Vector2) => set(v, a.x / b.x, a.y / b.y)

export const ceil = (v: Vector2, a: Vector2) => set(v, _ceil(a.x), _ceil(a.y))

export const floor = (v: Vector2, a: Vector2) => set(v, _floor(a.x), _floor(a.y))

export const min = (v: Vector2, a: Vector2, b: Vector2) => set(v, _min(a.x, b.x), _min(a.y, b.y))

export const max = (v: Vector2, a: Vector2, b: Vector2) => set(v, _max(a.x, b.x), _max(a.y, b.y))

export const round = (v: Vector2, a: Vector2) => set(v, _round(a.x), _round(a.y))

export const scale = (v: Vector2, a: Vector2, b: number) => set(v, a.x * b, a.y * b)
...
export const length = (a: Vector2) => sqrt(a.x * a.x + a.y * a.y)

export const squaredLength = (a: Vector2) => a.x * a.x + a.y * a.y

export const negate = (v: Vector2, a: Vector2) => set(v, -a.x, -a.y)

export const inverse = (v: Vector2, a: Vector2) => set(v, 1.0 / a.x, 1.0 / a.y)
...
export const exactEquals = (a: Vector2, b: Vector2) => a.x === b.x && a.y === b.y
